                    ...
                    >
                        ...
                        <template v-slot:activator="{ props }">
                            <v-btn
                                ...
                                v-bind="props"
                            >
                                {{ isCompanyPage ? $t('Declare service fee') : $t('Declare cashback') }}
                            </v-btn>
                        </template>
                        <v-card>
                            <v-card-title>
                                <span class="text-h5">{{ isCompanyPage ? $t('Declare service fee') : $t('Declare cashback') }}</span>
                            </v-card-title>
                            ...
                            <v-card-text>
                                ...
                                <v-col
                                    cols="12"
                                >
                                    <p>{{ $t('The maximum amount to be enrolled') }}: {{ maxCashback }} {{ $t('Lari') }}</p>
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                ...
                                <v-col
                                    cols="12"
                                >
                                    <p>{{ $t('The maximum amount to be enrolled') }}: {{ availableCashback }} {{ $t('Lari') }}</p>
...
export default {
  ...
  props: ['serverItems', 'managerId', 'maxCashback', 'isCompanyPage', 'maxServiceFee', 'availableCashback'],
  data: () => ({
    select: null,
    dialogExisted: false,
  ...
  computed: {
    headers() {
      return [
        ...
        {title: this.$t('Date of transfer'), key: 'transaction_date', align: 'start'},
  ...
  methods: {
    ...
    getText(type) {
      return type == 1 ? this.$t('Deposit cashback') : type == 2 ? this.$t('Service fee') : this.$t('Withdrawal cashback');
    },
    saveExisted() {
      axios.post('/api/pay/cashback', {
        ...this.cashbackManager,
        company_id: this.isCompanyPage ? this.$route.params.id : this.$route.params.companyId,
