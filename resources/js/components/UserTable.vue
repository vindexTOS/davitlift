    ...
    <div>
        ...
        >
                    ...
                    <v-menu>
                        <template v-slot:activator="{ props }">
                            <v-icon
                               ...
                               size="large"  icon="mdi-dots-vertical" v-bind="props"></v-icon>
                        </template>
            ...
            <template v-slot:item.name="{item}">
                <RouterLink v-if="$store.state.auth.user.lvl >= 3" :to="`/user/${item.raw.id}`">{{ item.raw.name }}</RouterLink>
    ...
    computed: {
        ...
        headers() {
            let header = [
              ...
              {title: this.$t('Count of cards'), key: 'cards_count', align: 'start'},
            ];
            if (this.isFixed) {
