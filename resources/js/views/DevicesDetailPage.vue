          ...
          <v-expansion-panel v-if="$store.state.auth.user.lvl >= 2">
            ...
            <template v-slot:text>
              <h4>
                ...
                {{
                  data.op_mode == 1
                    ? $t('Tariff') + data.tariff_amount + $t('Tetri')
                    : this.$t('Fixed') +
              ...
              <h4 v-if="$store.state.auth.user.lvl >= 4">
                {{ $t('LCD brightness') }}: {{ data.lcd_brightness }}%
              </h4>
              <h4 v-if="$store.state.auth.user.lvl >= 4">
                {{ $t('LED brightness') }}: {{ data.led_brightness }}%
              </h4>
              <h4 v-if="$store.state.auth.user.lvl >= 4">
                {{ $t('Card reading time') }}: {{ data.card_read_delay
                }}{{ $t('Second') }}
              </h4>
              <h4 v-if="$store.state.auth.user.lvl >= 4">
                {{ $t('Message display time') }}: {{ data.msg_appear_time
                }}{{ $t('Second') }}
              </h4>
              <h4 v-if="$store.state.auth.user.lvl >= 4">
                {{ $t('Relay pulse time') }}: {{ data.relay_pulse_time
                }}{{ $t('Second') }}
              </h4>
              <h4 v-if="$store.state.auth.user.lvl >= 4">
              ...
              <h4>
                {{ $t('Last update') }}:{{
                  data.last_update && data.last_update.updated_at
                    ? formatDateToCustomFormat(
                        new Date(data.last_update.updated_at),
                      )
                    : '-'
                }}
              </h4>
