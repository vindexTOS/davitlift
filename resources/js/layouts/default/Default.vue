    ...
    >
      <v-list density="compact" nav>
        ...
        <v-list-item
          :key="'devices'"
          v-if="user.lvl === 4"
          prepend-icon="mdi-elevator-passenger-outline"
          to="/devices"
        >
          {{ $t('Lifts') }}
        </v-list-item>
        <v-list-item
          :key="'unregistreddevices'"
          v-if="user.lvl >= 4"
...
.notification-container {
    ...
    position: fixed;
    z-index: 10000;
    background-color: rgb(255, 255, 255); /* White background for visibility */
    width: 400px;
    height: 600px;
    top: 370px;
    right: 50px;
    ...
    color: rgb(29, 22, 22); /* White text for contrast */
    border-radius: 5px;
